    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="flex items-center justify-between px-4 py-3 border-b border-border/50">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-muted-foreground hidden sm:inline">Speech & Text → American Sign Language (ASL)</span>
        </div>
        <div className="flex items-center gap-2">
          <button
      ...
      {showInfo && (
        ...
        >
          <div className="text-xs text-muted-foreground leading-relaxed max-w-2xl space-y-2">
            ...
            <p>
              <strong className="text-foreground">📚 80+ ASL words supported:</strong> hello, thank you, yes, no, please, help, love, happy, sad, numbers 1-10, colors (red, blue, green, yellow), emotions, family (mother, father, friend), and more. Other words are finger-spelled.
            </p>
          </div>
        </motion.div>
      )}
